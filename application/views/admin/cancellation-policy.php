				...
				<div class="card">
					<div class="card-body">
						<div class="card-block">
							<form action="<?= base_url()?>admin/update_cancellation" method="POST">
							<h4 class="form-section-h">Post Details</h4>
							<div class="form-group row">
								<div class="col-sm-12">
									<label class="label-control">Content </label>
									<textarea name="content" cols="8" rows="4" class="text-control" id="editor1" placeholder="Content Here"><?= $cancellation[0]->content ?></textarea>
								</div>
							</div>
						</div>
					</div>
