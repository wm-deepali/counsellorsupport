					...
					<div class="col-md-6 col-4 nopad">
						<div class="social-icon">
							<ul>
								...
								<li><a href="<?= $social[0]->whatsapp_link ?>"><i class="<?= $social[0]->whatsapp ?>"></i></a>
								</li>
							</ul>
						</div>
					</div>
					<div class="col-md-6 col-8 nopad">
						<div class="top-menu">
							<ul>
								...
								<li class="active"><a href="<?= base_url() ?>consult-online">Consult Now</a>
								</li>
							</ul>
						</div>
					</div>
						...
						<ul class="navbar-nav m-auto">
							...
							<li class="nav-item dropdown">
								...
								<div class="dropdown-menu" aria-labelledby="navbarDropdown">
									...
									<a class="dropdown-item" href="<?= base_url() ?>consult-online">Consult Now</a>
								</div>
							</li>
							</li>
							<li class="nav-item">
