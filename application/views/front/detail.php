			...
			<div class="col-sm-4">
				<div class="payment">
					...
					<table class="table">
						...
						<tr>
							<td class="label"><strong>Fee.</strong>
							</td>
							<td class="data"><span> <?= $user[0]->amount ?></span>
							</td>
						</tr>
						<tr>
							...
							<div class="payment-modal">
								<div class="row">
									<div class="col-sm-6 border-1r text-center">
										<h4>Scan QR Code</h4>
										<img src="<?= base_url() ?>assets/images/qr.jpg" class="img-fluid">
									</div>
									...
									<form action="<?= $action ?>" method="post" name="payuForm">
													...
													<input name="amount" type="hidden" value="<?php echo (empty($user[0]->amount)) ? '' : $user[0]->amount; ?>" id="amount"> 
													<input name="firstname" type="hidden" id="firstname" value="<?php echo (empty($user[0]->name)) ? '' : $user[0]->name; ?>" />
