...
class Admin_model extends CI_model
{
	...
	public function get_appointment()
	{
        ...
        consult_packages.price as package_price,
        consult_packages.price_type as price_type,
        timing.from_, 
        timing.to_,
        timing.date as appoint_date,
        timing.days as day,
        payment_online.added_on as date,
        payment_online.status,
        payment_online.transaction_id
    ");
...
// ===============================
	...
	public function get_consult_categories()
	{
		return $this->db
	...
	public function add_consult_category($data)
	{
		return $this->db->insert('consult_categories', $data);
	}

	public function get_consult_category_by_id($id)
	{
		return $this->db->where('id', $id)->get('consult_categories')->row();
	}

	public function update_consult_category($data, $id)
	{
		return $this->db->where('id', $id)->update('consult_categories', $data);
	}

	public function delete_consult_category($id)
	{
		return $this->db->where('id', $id)->delete('consult_categories');
	}
...
// ===============================
	...
	public function get_consult_packages()
	{
		return $this->db
			->select('p.*, c.name as category')
			->from('consult_packages p')
			->join('consult_categories c', 'c.id=p.category_id')
			->order_by('p.sort_order', 'ASC')
			->get()->result();
	}

	public function add_consult_package($data)
	{
		$this->db->insert('consult_packages', $data);
		return $this->db->insert_id();
	}

	public function get_consult_package_by_id($id)
	{
		return $this->db->get_where('consult_packages', ['id' => $id])->row();
	}

	public function update_consult_package($data, $id)
	{
		return $this->db->where('id', $id)->update('consult_packages', $data);
	}

	public function delete_consult_package($id)
	{
		$this->db->delete('consult_package_features', ['package_id' => $id]);
		return $this->db->delete('consult_packages', ['id' => $id]);
	}

	public function add_package_feature($data)
	{
		return $this->db->insert('consult_package_features', $data);
	}

	public function get_package_features($package_id)
	{
		return $this->db->get_where('consult_package_features', ['package_id' => $package_id])->result();
	}

	public function delete_package_features($package_id)
	{
		return $this->db->delete('consult_package_features', ['package_id' => $package_id]);
	}
